...
pub struct PerkOptionData {
    ...
    #[serde(rename = "modelingNote", skip_serializing_if = "Option::is_none")]
    modeling_note: Option<String>,
}
impl PerkOptionData {
    ...
    pub fn options_with_note(_options: Vec<&str>, _modeling_note: &str) -> PerkOptionData {
        let mut data = PerkOptionData::options(_options);
        data.modeling_note = Some(_modeling_note.to_string());
        data
    }
}
