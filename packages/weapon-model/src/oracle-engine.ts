import { weaponsStatDamageScalar } from './calculations';
import { calculateManifestStats, selectedPlugHashes, transformWeaponStatValue } from './catalog';
import type {
    WeaponCatalog,
    WeaponDefinition,
    WeaponEffectOption,
...
type EngineModule = typeof import('@rose/weapon-engine/wasm');
...
async function loadEngine() {
    enginePromise ??= import('@rose/weapon-engine/wasm')
        .then(async (module) => {
