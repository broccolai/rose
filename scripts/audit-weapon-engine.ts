import { createDefaultSelection } from '@/features/weapons/catalog';
import { calculateWeapon } from '@/features/weapons/oracle-engine';
import type { WeaponCatalog, WeaponEngineCalculation } from '@/features/weapons/types';
...
const engine = await import('@/features/weapons/wasm/generated/rose_weapon_engine');
